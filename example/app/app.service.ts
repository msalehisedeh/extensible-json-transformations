...
export class AppService {
    ...
    usersList() {
        ...
        return of({data: this.users, transformations: this.usersTrans});
    }
    eventsList() {
      // 'http://acesinc.net/introducing-a-streaming-json-data-generator/'
      return of({data: this.events, transformations: this.eventsTrans});
  }
  productsList() {
    // 'http://acesinc.net/introducing-a-streaming-json-data-generator/'
    return of({data: this.products, transformations: this.productsTrans});
}
